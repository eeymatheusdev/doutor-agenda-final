...
import { deleteDoctorFinance } from "@/actions/doctor-finances";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function FinancialsTableActions({
  ...
  const { execute, isExecuting } = useAction(deleteDoctorFinance, {
    onSuccess: () => {
      toast.success("Lançamento deletado com sucesso.");
      queryClient.invalidateQueries({
        queryKey: ["doctor-finances", entry.doctorId],
      });
    },
    onError: () => {
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  onClick={() =>
                    execute({ id: entry.id, doctorId: entry.doctorId })
                  }
